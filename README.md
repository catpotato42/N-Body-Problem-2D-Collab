...
### Use instructions
1. Download the .zip from the Releases tab on the right and extract, then double click on the .exe in the folder to run. If a possible virus window pops up, press more info then run anyway.
